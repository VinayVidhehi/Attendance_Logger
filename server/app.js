...
const { handleUserLogin, handleUserSignup, attendanceUpdate, getStudentAttendance, getStaffAttendance, handleCourseDetails,  handleFetchCourseDetails, checkCounsellor } = require('./router');
